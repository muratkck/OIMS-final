...
import admin_avatar from "../assets/media/admin_avatar.png";
import recruiter_avatar from "../assets/media/recruiter_avatar.png";
import student_avatar from "../assets/media/student_avatar.png";
            ...
            <div className="wrapper">
                ...
                <div className="profile-container">
                    <div className="first-col">
                        { user?.role === 'recruiter' &&
                        <img src={recruiter_avatar} alt="avatar" className="avatar" />
                    }
                    { user?.role === 'admin' &&
                        <img src={admin_avatar} alt="avatar" className="avatar" />
                    }
 
                    { user?.role === 'user' &&
                        <img src={student_avatar} alt="avatar" className="avatar" />
                    }
