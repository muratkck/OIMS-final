...
module.exports.getAllAvailableJobs = async (req, res, next) => {
    try {
        const filters = { ...req.query }; // to make a copy so that original don't moidfied
        filters.adminApproval = true;
        // exclude
        const excludeFields = ["sort", "page", "limit", "fields", "search"];
        excludeFields.forEach((field) => delete filters[field]);
...
module.exports.getAllPendingJobs = async (req, res, next) => {
    try {
...
//console.log("MURATTTTTTTTTTTTTTTT")
...
/*
module.exports.approveJob = async (req, res, next) => {
    //console.log("MURATTTTTTTTTTTTTTTT")
